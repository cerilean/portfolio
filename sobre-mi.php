            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav me-auto mb-2 mb-md-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active py-1 px-3 px-sm-2" href="sobre-mi.php">Sobre mi</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-3 col-12 mt-4 offset-sm-2">
                    <img src="images/yo.jpg" alt="Leandro Cerillano" title="Leandro Cerillano"
            ...
            <div class="row shadow bg-white rounded">
                ...
                <div class="row">
                    ...
                    <div class="col-12- col-sm-10 p-3">
                        ...
                        <h4>TodoCash</h4>
                        <h5>2021 - presente</h5>
                        <p>Gestión de sistemas para la primera red de cajeros operada por una empresa no financiera con procesamiento independiente que funciona con billeteras virtuales.</p>
                    </div>
                </div>
            </div>
                <div class="col-12">
